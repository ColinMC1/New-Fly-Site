...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/hero1.jpg', title : '<div class="slide-content">Aerial Yoga</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/hero2.jpg', title : '<div class="slide-content">Suspension Yoga</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/hero3.jpg', title : '<div class="slide-content">Suspended Barre</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/hero4.jpg', title : '<div class="slide-content">Pilates Sculpt</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/hero5.jpg', title : '<div class="slide-content">Reformer Pilates</div>', thumb : '', url : ''}  
									],
...
CHAKRA.map = function(){
	if($('.map').length > 0)
	{
		...
		$('.map').each(function(i,e){
			...
			var contentString = '<p><strong>Fly Studio</strong><br>489 Queen St W</p>';
